...
class SoundAdjustTableViewCell: UITableViewCell, AVAudioPlayerDelegate {
    ...
    override func awakeFromNib() {
        ...
        self.minimumIconImageView.image = UIImage(named: ImageName.soundIconImage.rawValue)
        self.maximumIconImageView.image = UIImage(named: ImageName.soundIconImage.rawValue)
        setLastState()
    }
